...
- [Grace De Vita](mailto:gracedevita@college.harvard.edu)
...
The course is designed to require about 10 hours of work per week, roughly divided as:

- 2 hours reading
- 0.5 hours on pre-class warmup questions
- 2.5 hours in the classroom
- 1.25 hours in section
- 4 hours on homework.
...
The planned schedule for sections is below:

| Topic                                                         | Meeting [^2]       |
|:--------------------------------------------------------------|:-------------------|
| **R Lab:** Intro to R                                         | 1  |
| **Replication:** Paper for replication selected               | 2  |
| **R Lab:** Basics of R                                        | 3  |
| **Replication:** Paper outlined, replication plan drafted     | 4  |
| **R Lab:** Data wrangling and basic summaries                 | 5  |
| **Replication:** Data cleaned, first summaries of data        | 6  |
| **R Lab/Replication:** Data visualization, the logic of ggplot | 7  |
| **R Lab/Replication:** Regressions, tables and related plots       | 8  |
| **Replication:** Continue work on main analyses, select extension | 9  |
| **Replication:** Work on extension (main analyses if need be)     | 10  |
| **Replication:** Work on presentation, finalizing extension       | 11 |
| **Replication:** Presentation to other TF (or Dr. Fuller)         | 12 |
